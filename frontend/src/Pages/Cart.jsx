...
const cart = () => {
  ...
  const [paymentption, setPaymentOption] = useState("COD");
  ...
  return products.length > 0 && cardItem ? (
    <div className="flex flex-col md:flex-row mt-16">
              ...
              <div>
                ...
                <div className="font-normal text-gray-500/70">
                  ...
                  <div className="flex items-center">
                    ...
                    <select
                      onChange={(e) =>
                        updateCardItem(product._id, Number(e.target.value))
                      }
                      value={cardItem[product._id]}
                      className="outline-none"
                    >
                      {Array(
                        cardItem[product._id] > 9 ? cardItem[product._id] : 9
                      )
                        .fill("")
                        .map((_, index) => (
      ...
      <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
        ...
        >
          {paymentption === "COD" ? "Please Order" : "Proceed to Checkout"}
        </button>
      </div>
    </div>
  ) : null;
